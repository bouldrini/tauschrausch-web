...
ActiveRecord::Schema.define(version: 20140702151811) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "counter_value_mappings", force: true do |t|
    t.integer "counter_value_id"
    t.integer "trade_item_id"
  end

  create_table "counter_values", force: true do |t|
    t.integer "trade_id"
  end

  create_table "follower_mappings", force: true do |t|
